...
from whisper_process_v6 import process_audio_file
...
def enqueue_transcription(file_path, output_dir, prompt_override=None, language_override=None):
    ...
    """
    try:
        job = transcription_queue.enqueue(process_audio_file, file_path, output_dir, prompt_override, language_override)
